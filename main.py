...
async def play_next(entry, vc):
    ...
    opts = '-vn'
    source = discord.FFmpegOpusAudio(source=source, executable='/app/vendor/ffmpeg/', before_options=before_opts, options=opts)
...
class Voice(commands.Cog):
    ...
    async def tts(ctx, message, language='en'):
        ...
        if member_voice_channel == None:
            ...
            source = discord.FFmpegOpusAudio(source='message.mp3', executable='/app/vendor/ffmpeg/')
